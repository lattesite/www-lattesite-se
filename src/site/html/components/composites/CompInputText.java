...
import lattesite.html.elements.HTMLInputElement;
import site.utils.CSSUtil;

public class CompInputText extends HTMLInputElement {

    public CompInputText(
            StyleContext sctx,
            HTMLElement parent
    ) {
        super(parent);

        this.addClass("comp-input-text");
    ...
    private void appendStyles(StyleContext sctx) {
        ...
        sctx.addClass("comp-input-text", (c) -> {
        ...
        sctx.addClass("comp-input-text:hover", (b) -> {
            b.setProperty("border-color", CSSUtil.COLOR_AE640A_BROWN_POTATO);
        });
        sctx.addClass("comp-input-text:focus", (b) -> {
            b.setProperty("border-color", CSSUtil.COLOR_AE640A_BROWN_POTATO);
        });

        sctx.addClass("comp-input-text:disabled", (b) -> {
